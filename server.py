...
def oauth2callback():
    flow = client.flow_from_clientsecrets(
        'client_secrets.json', # TODO: Will need to supply a client_secrets.json file containing the cient_id and secret_id
        scope='',  # TODO: add the uris for Google apis in use
